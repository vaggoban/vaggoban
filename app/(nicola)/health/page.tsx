...
export default function page() {
  return (
    ...
    sm:w-1/2 sm:mx-auto sm:py-32 py-24">
      ...
      <Link href="./care"><div className='text-lg border border-cyan-600 py-1 px-1 text-center bg-slate-200 font-medium w-32 mt-2 border-2  rounded  bg-transparent'>why us</div></Link>
      </div>
    </div>
   </div>
  )
