...
<form
  ...
  method="POST"
  className='flex flex-col  items-center my-16 sm:w-1/2 mx-auto pb-5'
>
...
<button type="submit" className='border-4 font-bold uppercase tracking-wider border-double mt-4 px-4 mb-5 py-2 '>Send</button>
</div>
</form>
    </div>
  )
